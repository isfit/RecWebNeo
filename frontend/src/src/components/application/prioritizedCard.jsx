...
const PrioritizedCard = ({ readOnly=false, prioritizedValue, setPrioritized}) => {
    ...
    return(
        <div className="card mb-2 px-3 py-2 w-100">
            ...
            <div className="flex-grid mb-3">
                {readOnly ? <input type="checkbox" checked={prioritizedValue} onclick={prioritizedValue} /> : <input type="checkbox" checked={prioritizedValue} onChange={() => setPrioritized(!prioritizedValue)} />}
